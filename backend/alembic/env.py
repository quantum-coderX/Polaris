"""
Alembic async environment for SQLAlchemy + asyncpg.
Uses run_sync to run migrations synchronously within the async engine context.
"""
import asyncio
...
# ── Online migrations (connect to DB) ───────────────────────────────────────
...
async def run_async_migrations() -> None:
    """Run migrations using async engine (asyncpg). Swap to psycopg2 URL for alembic."""
